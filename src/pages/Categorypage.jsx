...
const CategoryPage = () => {
  return <div>  
      ...
      <h1 className="text-[55px] text-black" style={{"font-family": "Poppins","font-weight": "700",
       "font-style": "italic","display":"flex", "alignItems":"center", "justifyContent":"center","color":"black"}}>Featured Products</h1> 
      <Products/>
      <NewsLetter/>
      <Footer/>
  </div>;
